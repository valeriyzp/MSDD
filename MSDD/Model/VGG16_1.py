...
class VGG16_1:
    ...
    def create_empty_model(num_of_classes):
        model = tf.keras.models.Sequential(name="vgg16_1")
        ...
        model.add(tf.keras.layers.Conv2D(filters=256, kernel_size=1, padding='same', activation='relu', name="block3_conv3"))
        ...
        model.add(tf.keras.layers.Conv2D(filters=512, kernel_size=1, padding='same', activation='relu', name="block4_conv3"))
        ...
        model.add(tf.keras.layers.Conv2D(filters=512, kernel_size=1, padding='same', activation='relu', name="block5_conv3"))
